...
class ProjectUsersModel extends Model{
     ...
     * @return type
     */
    public function get_user_list($proj_id){
        $sql = "select a.user_id,b.real_name from max_project_users a LEFT JOIN max_user b on a.user_id = b.user_id where a.proj_id = $proj_id and a.is_del =1";
