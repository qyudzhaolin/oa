...
jQuery(document).ready(function($) {
	...
	$(".add_btn").click(function(event) {
		...
		html+='		<input class="form-control input-sm usable_money" type="text" disabled="disabled" maxlength="10">'
		html+='	</td>'
		html+='	<td class="col-md-1">'
		...
		html+='	</td>'
		html+='	<td class="col-md-2">'
		html+='		<input class="form-control input-sm remit_date" type="text" maxlength="100">'
		html+='	</td>'
		html+='	<td class="col-md-2">'
	...
	//显示input
	/*$("#bank_name input").bind('input propertychange', function() { 
		getSuplist();
		$(this).siblings('#bank_name_list').show();
	});*/
