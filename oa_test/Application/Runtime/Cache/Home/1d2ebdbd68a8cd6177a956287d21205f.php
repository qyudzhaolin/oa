...
<div class="mainContent">
	...
	<div class="search_main">
		<a id="add_btn" class="btn btn-primary" href="<?php echo U('Contract/add');?>?proj_id=<?php echo ($_GET['proj_id']); ?>">&nbsp;&nbsp;新增合同&nbsp;&nbsp;</a>
		<div class="search_input">
			<div class="col-lg-9">
			    <div class="input-group">
			      <input type="text" class="form-control" placeholder="项目编号" id="keyword" value="<?php echo ($_GET['keyword']); ?>">
			...
			<tbody>  
                <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr class="table_bd active">
					...
					<td class="operate" id="<?php echo ($vo["ct_id"]); ?>">		
					    <?php if(($user_id) == $vo["crt_user_id"]): ?><a href="<?php echo U('Contract/add');?>?proj_id=<?php echo ($vo["proj_id"]); ?>&id=<?php echo ($vo["ct_id"]); ?>" class="edit">修改</a>
...
jQuery(document).ready(function($) {
	$("#search").click(function(){
		window.location.href="<?php echo U('Contract/index');?>?proj_id=<?php echo ($_GET['proj_id']); ?>&keyword="+$("#keyword").val();
	});
