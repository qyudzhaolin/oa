...
<script type="text/javascript" src="/oa/oa_test/Application/Home/Public/js/news_add.js"></script>
		<!-- S-页面主要部分 -->
		<div class="mainContent">
			<ol class="breadcrumb">
			  <li><a href="<?php echo U('News/index');?>">新闻库</a></li>
			  <li class="active">新增/修改新闻库</li>
			</ol>
			<!-- S-填写部分 -->
			<form action="<?php echo U('News/save');?>" method="post" name="forms" id="forms">	
				<input type="hidden" value="<?php echo ($info["id"]); ?>" name="news_id" id="news_id" >
				<input type="hidden" value="<?php echo U('News/index');?>" name="back_url" id="back_url" >			
				<div class="list_main">		
				
					<div class=" list">
					  <div class="col-xs-2 name">新闻标题</div>
					  <div class="col-xs-10 input_text">
					  	<div class="col-sm-10 col-md-3">
					    	<input type="text" class="form-control" value="" id="titile" name="titile" placeholder="请输入新闻标题">
					    </div>
					  </div>
					</div>

					<div class=" list">
					  <div class="col-xs-2 name">新闻来源</div>
					  <div class="col-xs-10 input_text">
					  	<div class="col-sm-10 col-md-3">
					    	<input type="text" class="form-control" value="<?php echo ($info["source"]); ?>" id="source" name="source" placeholder="请输入新闻来源">
					    </div>
					  </div>
					</div>

					<div class=" list">
					  <div class="col-xs-2 name">新闻内容</div>
					  <div class="col-xs-10 input_text">
					  	<div class="col-sm-10 col-md-3">
					    	<input type="text" class="form-control" value="<?php echo ($info["content"]); ?>" id="content" name="content" placeholder="请输入新闻内容">
					    </div>
					  </div>
					</div>
