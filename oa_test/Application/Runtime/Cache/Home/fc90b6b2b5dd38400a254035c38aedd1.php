...
<script charset="utf-8" src="/oa/oa_test/Public/kindeditor/kindeditor.js"></script>
<script charset="utf-8" src="/oa/oa_test/Public/kindeditor/lang/zh_CN.js"></script>
<style>
...
<div class="mainContent">
	<ol class="breadcrumb">
	  <li><a href="<?php echo U('User/index');?>">用户库</a></li>
			...
			<div class=" list">
			  ...
			  <div class="col-xs-10 input_text">
			  	<div class="col-xs-3" style="width:600px">
			    	<textarea id="description" class="textarea_wx" style="height: 400px;" name="description"><?php echo ($notice["description"]); ?></textarea>
			    </div>
			  </div>
			</div>
...
jQuery(document).ready(function($) {
	KindEditor.ready(function(K) {
   	    window.editor = K.create('#description',{
   	    	width : "100%",
   	    	resizeType : 1,
   	    	uploadJson : "<?php echo U('Uploadfy/kindeditor','','');?>",
   	    	items : [
	...
	$("#Submit").click(function(event) {
		...
		$.ajax({
			...
			success:function(data){
				if(data.status == 1){
					alert("操作成功！","<?php echo U('Notice/add');?>");
				}else{
					alert(data.msg);
					return false;
				}
