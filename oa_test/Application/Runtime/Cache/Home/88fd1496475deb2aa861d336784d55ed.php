		...
		<div style="float:right;">	
			<div class="form-group">		
				<div class="input-group">
			      <input type="text" class="form-control" id="keyword" value="<?php echo ($_GET['keyword']); ?>" placeholder="请输入姓名">
			...
			<table class="table-striped table-bordered table-hover ">
				<thead>
					<tr id="table_head">
						<th>姓名</th>
						<th>所在部门</th>
						<?php if($phone_watch): ?><th>手机</th><?php endif; ?>
					    <th>邮箱</th>
					</tr>
				</thead>
				<tbody>  
	                <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr class="table_bd active">
						...
						<td><?php echo ($vo["company_name"]); ?>--<?php echo ($vo["depart_name"]); ?></td>
						<?php if($phone_watch): ?><td><?php echo ($vo["phone"]); ?></td><?php endif; ?>
...
jQuery(document).ready(function($) {
	$("#search").click(function(){
		window.location.href="<?php echo U('Book/index');?>?keyword="+$("#keyword").val();
	})
});
</script></div>
</div>
