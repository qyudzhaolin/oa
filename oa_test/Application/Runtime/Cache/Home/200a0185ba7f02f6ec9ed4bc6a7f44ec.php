		...
		<div class="mainContent">
			...
			<div class="search_main form-inline">
				<div style="float:left;">
					<a id="add_btn" class="btn btn-primary" href="<?php echo U('Mjsupplier/add');?>">&nbsp;&nbsp;新增&nbsp;&nbsp;</a>
				</div>
				<div style="float:right;">
					<div class="form-group">
						<form name="searchform" action="<?php echo U('Mjsupplier/index');?>" method="post">
						   <div class="input-group">
						      <input type="text" placeholder="供应商名称/简称" value="<?php echo ($search["sup_full_name"]); ?>" name="sup_full_name" class="form-control">
					...
					<table class="table-striped table-bordered table-hover ">
						...
						<tbody>  
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="table_bd active">
								...
								<td>
									<?php echo ($vo["pay_method"]); ?>							
								</td>
								<td>
									<?php echo ($vo["bnk_branch"]); ?>
								</td>
								<td>
									<?php echo ($vo["bnk_acct"]); ?>
								</td>
								<td>
									<?php echo ($vo["other"]); ?>
								</td>
								<td class="operate">
									<a href="<?php echo U('Mjsupplier/add',array('id'=>$vo['sup_id']));?>" class="edit">修改</a>
									<a href="javascript:void(0)" value="<?php echo ($vo["sup_id"]); ?>" url="<?php echo U('Mjsupplier/del');?>" class="deleat">删除</a>
								</td>
