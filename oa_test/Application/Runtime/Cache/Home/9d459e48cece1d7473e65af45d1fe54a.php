...
<div class="mainContent">
	...
	<div class="search_main form-inline">
		<div style="float:left;">
			<?php if($is_proj_add): ?><a id="add_btn" class="btn btn-primary" href="<?php echo U('Project/add');?>">&nbsp;&nbsp;新增项目&nbsp;&nbsp;</a><?php endif; ?>
		</div>
		<div style="float:right;">
			<div class="form-group">
			    <div class="input-group">
			      <input type="text" class="form-control" id="keyword" value="<?php echo ($_GET['keyword']); ?>" placeholder="请输入项目名称/编号">
			...
			<table class="table-striped table-bordered table-hover ">
				...
				<tbody>  
	                <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr class="table_bd active">
						...
						<td><?php echo ($vo["proj_mgr"]["real_name"]); ?></td>
						<td><?php echo ($vo["users"]); ?></td>
						<td><a href="<?php echo ($vo["file_url"]); ?>" target="_blank"><?php echo ($vo["file_name"]); ?></a></td>
						<td><a href="<?php echo ($vo["other_file_url"]); ?>" target="_blank"><?php echo ($vo["other_file_name"]); ?></a></td>
						<td><a href="<?php echo U('Contract/index');?>?proj_id=<?php echo ($vo["proj_id"]); ?>" class="edit">合同</a></td>
						<td><?php echo ($vo["crt_user"]["real_name"]); ?></td>
						<td><?php echo ($vo["crt_time"]); ?></td>
						<td class="operate" id="<?php echo ($vo["proj_id"]); ?>">		
							<?php if($lvl_id == '1' or $lvl_id == '2'): ?><a href="<?php echo U('Project/add');?>?proj_id=<?php echo ($vo["proj_id"]); ?>" class="edit">修改</a>
								<a href="javascript:;" class="deleat">删除</a>
						    <?php else: ?>	
						    <?php if(($user_id) == $vo["crt_user_id"]): ?><a href="<?php echo U('Project/add');?>?proj_id=<?php echo ($vo["proj_id"]); ?>" class="edit">修改</a>
								<a href="javascript:;" class="deleat">删除</a>
							<?php else: ?>
								<a href="<?php echo U('Project/info');?>?proj_id=<?php echo ($vo["proj_id"]); ?>" class="edit">详情</a><?php endif; endif; ?>
							<?php if(check_permission_left('Project', 'over')){ ?>
							<?php if($vo["is_over"] == '1'): ?>已结束
							<?php else: ?>
							<a href="javascript:;" class="edit over">结束</a><?php endif; ?>
							<?php } ?>
						</td>
...
jQuery(document).ready(function($) {
	...
	$("#search").click(function(){
		window.location.href="<?php echo U('Project/index');?>?keyword="+$("#keyword").val();
	});
