...
<div class="mainContent">
	<ol class="breadcrumb">
	  <li class="active">新闻管理开发</li>
	</ol>
	<!-- S-搜索框部分 -->
	<div class="search_main form-inline">
		<div style="float:left;">
			<a id="add_btn" class="btn btn-primary" href="<?php echo U('News/add');?>">&nbsp;&nbsp;新增&nbsp;&nbsp;</a>
		</div>
		<div style="float:right;">
			<form name="searchform" action="<?php echo U('News/index');?>" method="post">
						<div class="form-group">
						    <div class="input-group">
						      <input type="text" placeholder="新闻标题名称" value="<?php echo ($search["cust_full_name"]); ?>" name="cust_full_name" class="form-control">
			...
			<div class="Pagination"><?php echo ($page); ?></div></div>
</div>
</div>
</div>
</div>
